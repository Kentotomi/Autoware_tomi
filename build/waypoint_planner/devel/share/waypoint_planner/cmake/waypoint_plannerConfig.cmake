...
if("TRUE" STREQUAL "TRUE")
  set(waypoint_planner_SOURCE_PREFIX /home/autoware/Autoware/src/autoware/core_planning/waypoint_planner)
  set(waypoint_planner_DEVEL_PREFIX /home/autoware/Autoware/build/waypoint_planner/devel)
  ...
  set(waypoint_planner_INSTALL_PREFIX /home/autoware/Autoware/install/waypoint_planner)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'waypoint_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/autoware/Autoware/src/autoware/core_planning/waypoint_planner/${idir}'.  ${_report}")
    endif()
